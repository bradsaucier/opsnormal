...
>
> The operating boundary is documented in [33 ADRs](./docs/decisions/README.md), a published [security and trust boundary](./SECURITY.md), and a release pipeline that publishes only the exact CI-verified production artifact under Sigstore-backed provenance and SBOM attestations.
...
| Decisions of record  | 33 ADRs under [`docs/decisions/`](./docs/decisions/README.md)                                                                |
