...
export const EXTERNAL_UPDATE_HANDOFF_DEADMAN_TIMEOUT_MS =
  UPDATE_HANDOFF_TIMEOUT_MS + 2000;
export const CONTROLLER_RELOAD_WINDOW_MS = 15 * 1000;
export const FOREGROUND_REVALIDATION_THROTTLE_MS = 60 * 1000;
export const CONTROLLER_RELOAD_COUNT_KEY =
  'opsnormal-sw-controller-reload-count';
export const CONTROLLER_RELOAD_LAST_AT_KEY =
  'opsnormal-sw-controller-reload-last-at';
export const CONTROLLER_RELOAD_MAX_AUTOMATIC_RELOADS = 2;
export const CONTROLLER_RELOAD_RECOVERY_CHANNEL_NAME =
  'opsnormal-pwa-update-recovery';
export const CONTROLLER_RELOAD_RECOVERY_CLEAR_MESSAGE =
  'controller-reload-recovery-cleared';
