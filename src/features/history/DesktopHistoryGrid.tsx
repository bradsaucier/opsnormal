  ...
  return (
    <>
      ...
      <div className="grid gap-4 lg:grid-cols-[minmax(0,1fr)_22rem]">
        ...
        <aside
          className="ops-sticky-safe-top lg:sticky lg:max-h-[calc(100vh-3rem)] lg:self-start"
          aria-live="polite"
        >
          <div
            className={`ops-flat-panel-strong p-5 ${getStatusSpineClassName(selectedStatus)}`}
          >
            ...
            <p className="mt-5 text-2xl leading-none font-semibold tracking-[0.02em] text-ops-text-primary [font-variant-numeric:tabular-nums]">
