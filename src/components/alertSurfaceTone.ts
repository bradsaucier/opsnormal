...
const tonePaletteByTone: Record<AlertSurfaceTone, AlertSurfaceTonePalette> = {
  info: {
    ...
    innerClassName:
      'ops-alert-surface ops-alert-tone-info bg-[linear-gradient(180deg,rgba(56,189,248,0.16),rgba(255,255,255,0.02)_30%),var(--color-ops-surface-raised)]',
  ...
  success: {
    ...
    innerClassName:
      'ops-alert-surface ops-alert-tone-success bg-[linear-gradient(180deg,rgba(110,231,183,0.08),rgba(255,255,255,0.02)),var(--color-ops-surface-raised)]',
  ...
  attention: {
    ...
    innerClassName:
      'ops-alert-surface ops-alert-tone-attention bg-[linear-gradient(180deg,rgba(245,158,11,0.16),rgba(255,255,255,0.02)_30%),var(--color-ops-surface-raised)]',
  ...
  warning: {
    outerClassName:
      'bg-[linear-gradient(180deg,rgba(251,191,36,0.32),rgba(255,255,255,0.04))]',
    innerClassName:
      'ops-alert-surface ops-alert-tone-warning bg-[linear-gradient(180deg,rgba(245,158,11,0.16),rgba(255,255,255,0.02)_30%),var(--color-ops-surface-raised)]',
    titleClassName: 'text-[var(--ops-text-on-amber)]',
  ...
  danger: {
    ...
    innerClassName:
      'ops-alert-surface ops-alert-tone-danger bg-[linear-gradient(180deg,rgba(127,29,29,0.42),rgba(255,255,255,0.02)_30%),var(--color-ops-surface-raised)]',
  ...
  neutral: {
    ...
    innerClassName:
      'ops-alert-surface ops-alert-tone-neutral bg-[linear-gradient(180deg,rgba(255,255,255,0.03),transparent_26%),var(--color-ops-surface-raised)]',
