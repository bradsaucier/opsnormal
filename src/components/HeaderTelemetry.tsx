...
function TelemetryChip({
  ...
  return (
    <div
      className={[
        'ops-telemetry-chip clip-notched ops-notch-chip tactical-chip-panel flex min-h-20 flex-col justify-between border px-3 py-3 text-left',
    ...
    >
      ...
      <span className="mt-2 text-lg leading-none font-semibold tracking-[0.06em] uppercase [font-variant-numeric:tabular-nums] sm:text-xl">
        {value}
      </span>
      {detail ? (
